		...
		<div className="loading-home-left flex">
			<div className="loading-card-post-container flex">
				<div className="post-user-info flex">
					<div className="loading-profile-image-div"></div>
					<div className="post-user-name-div flex">
						<div className="loading-post-user-name-div-username"></div>
				...
				<div className="post-info">
					<div className="post-function-bar flex">
						<div className="loading-post-function-bar-left"></div>
					</div>
					<div className="loading-image-likes"></div>

					<div className="post-all-comments"></div>
